...
class zmq_audio_test(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Zmq Audio Test")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Zmq Audio Test")
        ...
        self.settings = Qt.QSettings("GNU Radio", "zmq_audio_test")
...
def main(top_block_cls=zmq_audio_test, options=None):
