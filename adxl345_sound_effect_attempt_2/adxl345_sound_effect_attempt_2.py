...
# Title: Adxl345 Sound Effect Attempt 2
...
class adxl345_sound_effect_attempt_2(gr.top_block, Qt.QWidget):
...
def main(top_block_cls=adxl345_sound_effect_attempt_2, options=None):
